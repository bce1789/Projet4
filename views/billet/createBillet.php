...
//Delete recupérer l'id (comme sur update) envoyer au model, dans le model crééer une fonction supprimer le billet avec l'id.
//Delete renvoi sur la list avec un message flash (supprimer message dans la session);
// Pour create ex menu (pas besoin de l'id) formulaire. Dans action > renvoi dans la function create, recupere les POST (info envoyé)
